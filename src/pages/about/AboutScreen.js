        ...
        <div className="bg-white rounded-xl p-3 font-title">
          ...
          <img
            ...
            <div>
              <a
                ...
                rel="noreferrer"
              >
                Hi, I'm Muhammad Usman Baber CEO
              </a>
              <h1> Free Smart Invoice for your business.</h1>
            </div>
          </div>

          <PageTitle title="Smart Invoice" />
          ...
          <div className="font-title mt-3 mb-5">
            ...
            <div>
              📫 How to reach me{" "}
              <a
                href="mailto:uk252811@gmail.com"
                className="underline cursor-pointer"
              >
                uk252811@gmail.com
              </a>{" "}
              (or){" "}
              <a
                href="https://www.facebook.com/usman.baber.1/"
                target={"_blank"}
                className="underline cursor-pointer"
                rel="noreferrer"
              >
